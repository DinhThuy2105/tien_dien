                        ...
                        <table id="users-datatable" class="table table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            <tr>
                                ...
                                <td><a href="{{route('users.edit',$user->id)}}" class="btn btn-default btn-sm"><i class="icon-fa icon-fa-edit"></i> Chỉnh sửa</a>
                                    <a data-toggle='modal' data-target='#confirm{{$user->id}}' href="{{route('users.destroy',$user->id)}}" class="btn btn-default btn-sm" data-token="{{csrf_token()}}" data-delete data-confirmation="notie"> <i class="icon-fa icon-fa-trash"></i> Xóa</a></td>
                            </tr>
        ...
        <div class="modal fade ls-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        ...
                        <input type="hidden" name="role" value="Nhân viên">
                            <div class="modal-body">
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control ls-select2 w-100" name="maloaidien" required>
